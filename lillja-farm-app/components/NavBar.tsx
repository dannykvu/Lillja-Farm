        ...
        `}>
            <div className='flex flex-row flex-1 justify-between'>
                <Link className={`transition-opacity duration-500`} href='/'>
                    <Image src='/logo.png' className='object-contain' alt='Lillja Farm' width={250} height={150} />
                    {/* <img src='/logo.png' className='w-2 object-contain' alt='Lillja Farm'></img> */}
                </Link>
                <div className='hidden md:flex items-center'>
                    <Link className='text-primary-text mr-4 hover:text-primary animate-slide-down hover:text-primary hover:scale-150' href='/'>Home</Link>
                    <Link className='text-primary-text mr-4 hover:text-primary animate-slide-down-2 hover:text-primary hover:scale-150' href='/#products'>Products</Link>
                    <Link className='text-primary-text mr-4 hover:text-primary animate-slide-down-3 hover:text-primary hover:scale-150' href='/#about'>About</Link>
                    <Link className='text-primary-text mr-4 hover:text-primary animate-slide-down-4 hover:text-primary hover:scale-150' href='/#contact'>Contact</Link>
                        ...
                        </button>
                        {
                            isMenuVisible && (
                                <div className='md:hidden flex flex-col pr-8 pl-4 animate-fade'>
                                    <Link className='text-primary-text text-xl mb-4 hover:text-primary' href='/'>Home</Link>
                                    <Link className='text-primary-text text-xl mb-4 hover:text-primary' href='/#products'>Products</Link>
                                    <Link className='text-primary-text text-xl mb-4 hover:text-primary' href='/#about'>About</Link>
                                    <Link className='text-primary-text text-xl mb-4 hover:text-primary' href='/#contact'>Contact</Link>
                                </div>
                            )
                        }
                    </div>
